                        ...
                        <div class="timeline-body with-border">
                            ...
                            <% else { %>
                                ...
                                <asp:PlaceHolder runat="server" ID="FPBUploadView" Visible="false">
                                    ...
                                    <!-- upload surat laporan klaim insiden -->
                                    <div class="box">
                                    ...
                                    <!-- upload invoice pengeluaran barang -->
                                    <div class="box">
                                    ...
                                    <!-- upload rekap pengeluaran barang -->
                                    <div class="box">
                                ...
                                <% if (status.StatusCode == "WA") { %>
                                    ...
                                    <div class="box">
                                        <a class="box-header bg-gray" data-toggle="collapse" href="#suratlaporan1" role="button" aria-expanded="false" aria-controls="uploadfbp">
                                          ...
                                          <% } else if (claimDetail.Documents.Where(x => x.Type == WebApplication1.Model.DocType.SuratLaporan).Select(x => x.Rejected).DefaultIfEmpty(false).FirstOrDefault()) { %>
                                          <div class="col-md-1"><i class="fa fa-times" style="color:red"></i></div>
                                          <% } %>
                                        </a>
                                    ...
                                    <div class="box">
                                        <a class="box-header bg-gray" data-toggle="collapse" href="#copyinvoice1" role="button" aria-expanded="false" aria-controls="uploadfbp">
                                          ...
                                          <% } else if (claimDetail.Documents.Where(x => x.Type == WebApplication1.Model.DocType.Invoice).Select(x => x.Rejected).DefaultIfEmpty(false).FirstOrDefault()) { %>
                                          <div class="col-md-1"><i class="fa fa-times" style="color:red"></i></div>
                                          <% } %>
                                        </a>
                                    ...
                                    <div class="box">
                                        <a class="box-header bg-gray" data-toggle="collapse" href="#lp1" role="button" aria-expanded="false" aria-controls="uploadfbp">
                                          ...
                                          <% } else if (claimDetail.Documents.Where(x => x.Type == WebApplication1.Model.DocType.LP1Bulan).Select(x => x.Rejected).DefaultIfEmpty(false).FirstOrDefault()) { %>
                                          <div class="col-md-1"><i class="fa fa-times" style="color:red"></i></div>
                                          <% } %>
                                        </a>
                                    ...
                                    <div class="box">
                                        <a class="box-header bg-gray" data-toggle="collapse" href="#suratjalan1" role="button" aria-expanded="false" aria-controls="uploadfbp">
                                          ...
                                          <% } else if (claimDetail.Documents.Where(x => x.Type == WebApplication1.Model.DocType.SuratJalan).Select(x => x.Rejected).DefaultIfEmpty(false).FirstOrDefault()) { %>
                                          <div class="col-md-1"><i class="fa fa-times" style="color:red"></i></div>
                                          <% } %>
                                        </a>
                                    ...
                                    <!-- approve invoice surat pengeluaran -->
                                    <div class="box">
                                        <a class="box-header bg-gray" data-toggle="collapse" href="#invoicepengeluaran1" role="button" aria-expanded="false" aria-controls="uploadfbp">
                                          ...
                                          <% } else if (claimDetail.Documents.Where(x => x.Type == WebApplication1.Model.DocType.InvoicePengeluaran).Select(x => x.Rejected).DefaultIfEmpty(false).FirstOrDefault()) { %>
                                          <div class="col-md-1"><i class="fa fa-times" style="color:red"></i></div>
                                          <% } %>
                                        </a>
                                    ...
                                    <div class="box">
                                        <a class="box-header bg-gray" data-toggle="collapse" href="#rekap1" role="button" aria-expanded="false" aria-controls="uploadfbp">
                                          ...
                                          <% } else if (claimDetail.Documents.Where(x => x.Type == WebApplication1.Model.DocType.RekapPengeluaran).Select(x => x.Rejected).DefaultIfEmpty(false).FirstOrDefault()) { %>
                                          <div class="col-md-1"><i class="fa fa-times" style="color:red"></i></div>
                                          <% } %>
                                        </a>
                                    ...
                                    <div class="box">
                                        <a class="box-header bg-gray" data-toggle="collapse" href="#qcreport1" role="button" aria-expanded="false" aria-controls="uploadfbp">
                                          ...
                                          <% } else if (claimDetail.Documents.Where(x => x.Type == WebApplication1.Model.DocType.QCReport).Select(x => x.Rejected).DefaultIfEmpty(false).FirstOrDefault()) { %>
                                          <div class="col-md-1"><i class="fa fa-times" style="color:red"></i></div>
                                          <% } %>
                                        </a>
                                ...
                                <% if (status.StatusCode == "WO") { %>
                                    <asp:PlaceHolder runat="server" ID="AONApproveView" Visible="false">
                                        <div class="box">
                                            <a class="box-header bg-gray" data-toggle="collapse" href="#aonfeedback" role="button" aria-expanded="false" aria-controls="uploadfbp">
                                              <div class="col-md-11">AON Feedback</div>                                             
                                            </a>
                                            <div class="collapse" id="aonfeedback">
                                                <div class="box-body">
                                                <% if (claimDetail.Documents.Where(x => x.Type == WebApplication1.Model.DocType.SuratPengajuan).Any()) { %>
                                                    <div class="form-group">
                                                        <div class="col-sm-12"><a href="<%= claimDetail.Documents.Where(x => x.Type == WebApplication1.Model.DocType.SuratPengajuan).OrderByDescending(x => x.Id).FirstOrDefault().FilePath %>"><%= claimDetail.Documents.Where(x => x.Type == WebApplication1.Model.DocType.SuratPengajuan).OrderByDescending(x => x.Id).FirstOrDefault().OriginalFileName %></a></div>
                                ...
                                <% if (status.StatusCode == "FB") { %>
                                    <asp:PlaceHolder runat="server" ID="TreasuryFeedBackView" Visible="false">
                                        <div class="box">
                                            <a class="box-header bg-gray" data-toggle="collapse" href="#treasuryfeedback" role="button" aria-expanded="false" aria-controls="uploadfbp">
                                              <div class="col-md-11">Treasury Feedback</div>                                             
                                            </a>
                                            <div class="collapse" id="treasuryfeedback">
                                                <div class="box-body">
                                                    <div class="form-group">
                                    ...
                                    <asp:PlaceHolder runat="server" ID="AONTambahanDokumen" Visible="false">
                                        <div class="box">
                                            <a class="box-header bg-gray" data-toggle="collapse" href="#aontambahan" role="button" aria-expanded="false" aria-controls="uploadfbp">
                                              <div class="col-md-11">Documents</div>                                             
                                            </a>
                                            <div class="collapse" id="aontambahan">
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label class="col-sm-2" for="claimformFile">Feedback</label>
                                    ...
                                    <asp:PlaceHolder runat="server" ID="TreasuryLSR" Visible="false">
                                        <div class="box">
                                            ...
                                            <div class="collapse" id="lsr">
                                                ...
                                                <div class="box-footer">
                                                    <% if (!claimDetail.Statuses.Where(x => x.StatusCode == "LSR").FirstOrDefault().Done) { %>
                                                    <div class="col-sm-12"><asp:Button runat="server" id="Button29" text="Upload" CssClass="btn btn-primary" onclick="UploadLSR_Click" /></div>
                                                    <% } %>
                                                </div>
                                            </div>
                                        </div>                                         
                                    ...
                                    <asp:PlaceHolder runat="server" ID="DisposalUploadView" Visible="false">
                                        <div class="box">
                                            ...
                                            <div class="collapse" id="disposal">
                                                ...
                                                <div class="box-footer">
                                                    <% if (!claimDetail.Statuses.Where(x => x.StatusCode == "DISP").FirstOrDefault().Done) { %>
                                                    <div class="col-sm-12"><asp:Button runat="server" id="Button31" text="Upload" CssClass="btn btn-primary" onclick="UploadDisposal_Click" /></div>
                                                    <% } %>
                                                </div>
                                            </div>
                                        </div>
         ...
         <div class="box box-info">
            ...
            <!-- form start -->            
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-5 control-label">Nama Distributor</label>
                  <p class="col-sm-6 form-control-static"><%= claimDetail.Distributor %></p>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label">Kode Distributor</label>
                  <p class="col-sm-6 form-control-static"><%= claimDetail.DistributorCode %></p>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label">Insiden Klaim</label>
                  <p class="col-sm-6 form-control-static"><%= claimDetail.Cause %></p>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label">Tanggal Kejadian</label>
                ...
                <div class="form-group">
                  <label class="col-sm-5 control-label">CF to be Notified</label>
