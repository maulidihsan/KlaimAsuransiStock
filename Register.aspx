                            ...
                            <asp:ListView ID="UserListView" ItemPlaceholderID="itemPlaceholder" ItemType="WebApplication1.Model.Profile" runat="server">
                                ...
                                <ItemTemplate>
                                  <tr>
                                    ...
                                    <td><asp:Button ID="btnDelete" runat="server" CausesValidation="false" CssClass="btn btn-danger" Text="Delete" CommandArgument='<%# Eval("Email")%>' OnClick="DeleteUser_Click" /></td>
                                  </tr>
                                </ItemTemplate>
                          </asp:ListView>
                        </div>
